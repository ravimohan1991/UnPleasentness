...
int main(int argc, char * argv[])
{
    ...
    std::cout << "Detour 1" << DetourInstallHook((void*)test_detour_b, (void*)test_detour_a, &test_detour_callback, test_detour_handle) << "\n";
    std::cout << "Detour 2" << DetourInstallHook((void*)sleep, (void*)sleep_detour, &sleep_detour_callback, sleep_detour_handle) << "\n";
